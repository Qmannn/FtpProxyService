...
class Pages {
    ...
    constructor() {
        ...
        this.pages.push(new PageInfo('Пользователи', AppConfig.RouteBaseUrl() + 'users', Page.UsersList, true));
        this.pages.push(new PageInfo('Аккаунты сайтов', AppConfig.RouteBaseUrl() + 'sites', Page.SiteList, true));
    }
